...
SELECT m.*,r."百分位" AS "全域PR",r."排名序" AS "全域名次",r."總序",r."相對百分位",r."評選合格",r."未達門檻原因",r."吉宮數",r."壯年吉限年數",r."壯年風險年數",r."首次吉限年齡",r."晚發限定",r."加權分" AS "得時分",COALESCE(p."吉格數",0)::INTEGER AS "吉格數",COALESCE(p."凶格數",0)::INTEGER AS "凶格數",p."最高稀有度",p."吉格",p."凶格"
