...
ORDER BY ${order ?? `r."${NAMES[dimension]}分" DESC, m."公曆日期", m."時辰序號", m."性別"`};`;
  ...
  const definitions = [
    ...
    q("career_risk","career","官祿不利","六煞、化忌或空宮入官祿。",{dimension:"career",join:G,fields:['m."官祿主星"','m."官祿全部星"','g."六煞入官祿"','g."官祿空宮"','m."化忌星"'],where:'g."六煞入官祿"=1 OR g."官祿空宮"=1 OR m."化忌宮位"=\'官祿\'',order:'r."事業分" ASC, m."公曆日期", m."時辰序號", m."性別"'}),
